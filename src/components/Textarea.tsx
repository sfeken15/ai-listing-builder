...
export const TextAreaBase = ({ className, size = "md", ...props }: TextAreaBaseProps) => {
    return (
        <AriaTextArea
            ...
            className={(state) =>
                cx(
                    "w-full scroll-py-3 rounded-lg bg-[var(--bg-surface)] text-[var(--text-primary)] shadow-[var(--shadow-xs)] ring-1 ring-[var(--border-default)] transition duration-100 ease-linear ring-inset placeholder:text-[var(--text-tertiary)] autofill:rounded-lg autofill:text-[var(--text-primary)] focus:outline-hidden",
